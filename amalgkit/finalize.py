...
def _simplify_table_filename(filename, species, batch_effect_alg):
    mapping = {
        ...
        '{}.{}.tau.linear_mean.tsv'.format(species, batch_effect_alg): '{}_tau_linear_mean.tsv'.format(species),
        '{}.{}.tau.coverage.tsv'.format(species, batch_effect_alg): '{}_tau_coverage.tsv'.format(species),
        '{}.{}.tau.weights.tsv'.format(species, batch_effect_alg): '{}_tau_weights.tsv'.format(species),
        '{}.{}.tau.definition.json'.format(species, batch_effect_alg): '{}_tau_definition.json'.format(species),
