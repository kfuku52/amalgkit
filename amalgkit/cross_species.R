...
if (mode=="debug") {
  #Brassica_rapa_abundance <- read_delim("Desktop/Curate/Done/Brassica_rapa/Brassica_rapa_abundance.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  #Brassica_rapa_metadata <- read_delim("Desktop/Curate/Done/Brassica_rapa/Brassica_rapa_metadata.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  #Brassica_rapa_eff_length <- read_delim("Desktop/Curate/Done/Brassica_rapa/Brassica_rapa_eff_length.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  
  Zea_mays_abundance <- read_delim("Desktop/Curate/Done/Zea_mays/Zea_mays_est_counts.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Zea_mays_metadata <- read_delim("Desktop/Curate/Done/Zea_mays/Zea_mays_metadata.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Zea_mays_eff_length <- read_delim("Desktop/Curate/Done/Zea_mays/Zea_mays_eff_length.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  
  Glycine_max_abundance <- read_delim("Desktop/Curate/Done/Glycine_max/Glycine_max_est_counts.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Glycine_max_metadata <- read_delim("Desktop/Curate/Done/Glycine_max/Glycine_max_metadata.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Glycine_max_eff_length <- read_delim("Desktop/Curate/Done/Glycine_max/Glycine_max_eff_length.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  
  Nicotiana_tabacum_abundance <- read_delim("Desktop/Curate/Done/Nicotiana_tabacum/Nicotiana_tabacum_abundance.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Nicotiana_tabacum_metadata <- read_delim("Desktop/Curate/Done/Nicotiana_tabacum/Nicotiana_tabacum_metadata.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Nicotiana_tabacum_eff_length <- read_delim("Desktop/Curate/Done/Nicotiana_tabacum/Nicotiana_tabacum_eff-length.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  
  Citrullus_lanatus_abundance <- read_delim("Desktop/Curate/Done/Citrullus_lanatus/Citrullus_lanatus_est_counts.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Citrullus_lanatus_metadata <- read_delim("Desktop/Curate/Done/Citrullus_lanatus/Citrullus_lanatus_metadata.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Citrullus_lanatus_eff_length <- read_delim("Desktop/Curate/Done/Citrullus_lanatus/Citrullus_lanatus_eff_length.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  
  Oryza_sativa_abundance <- read_delim("Desktop/Curate/Done/Oryza_sativa/Oryza_sativa_est_counts.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Oryza_sativa_metadata <- read_delim("Desktop/Curate/Done/Oryza_sativa/Oryza_sativa_metadata.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  Oryza_sativa_eff_length <- read_delim("Desktop/Curate/Done/Oryza_sativa/Oryza_sativa_eff_length.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
  
  common_cols<- Reduce(intersect, list(colnames(Glycine_max_metadata),
                            colnames(Nicotiana_tabacum_metadata),
                            colnames(Citrullus_lanatus_metadata),
                            colnames(Oryza_sativa_metadata),
                            colnames(Zea_mays_metadata)))
  
  Metadata_all <- rbind(
    subset(Zea_mays_metadata, select = common_cols),
    subset(Glycine_max_metadata, select = common_cols)
    )
  Metadata_all <- rbind(Metadata_all, subset(Nicotiana_tabacum_metadata, select = common_cols))
  Metadata_all <- rbind(Metadata_all, subset(Citrullus_lanatus_metadata, select = common_cols))
  Metadata_all <- rbind(Metadata_all, subset(Oryza_sativa_metadata, select = common_cols))
  
  
  #create nonsense OGs REPLACE WITH ACTUAL OGs AS SOON AS ORTHOFINDER IS DONE
  
  OG_abundance <- do.call(cbind, list(Citrullus_lanatus_abundance[1:20000,],
                      Zea_mays_abundance[1:20000,],
                      Glycine_max_abundance[1:20000,-1],
                      Nicotiana_tabacum_abundance[1:20000,-1],
                      Oryza_sativa_abundance[1:20000,-1]
                      ))
  
  OG_eff_length <- do.call(cbind, list(Citrullus_lanatus_eff_length[1:20000,],
                                       Zea_mays_eff_length[1:20000,],
                                       Glycine_max_eff_length[1:20000,-1],
                                       Nicotiana_tabacum_eff_length[1:20000,-1],
                                       Oryza_sativa_eff_length[1:20000,-1]
                                       ))
  
  
  
  infile = '/Users/s229181/Desktop/Curate/Nicotiana_tabacum/Nicotiana_tabacum_abundance.tsv'
  eff_file = '/Users/s229181/Desktop/Curate/Nicotiana_tabacum/Nicotiana_tabacum_eff-length.tsv'
  srafile = '/Users/s229181/Desktop/Curate/Nicotiana_tabacum/Nicotiana_tabacum_metadata.tsv'
  outdir = '/Users/s229181/Desktop/Curate/'
  dist_method="pearson"
...
transform_raw = function(tc, tc_eff_length){
  res = tc[NA,]
...
tc = transform_raw(tc, tc_eff_length)

tc_tissue_uncorrected = tissue_mean(tc, sra, selected_tissues)
write.table(tc_tissue_uncorrected, file=paste0(sub(' ', '_', "cross_species"), '.uncorrected.tissue.mean.tsv'), sep="\t", row.names=TRUE, col.names=TRUE, quote=FALSE)
